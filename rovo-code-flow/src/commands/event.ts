...
export async function eventCommand(role: string, description?: string): Promise<void> {
  ...
  if (!validRoles.includes(role)) {
    console.log(chalk.red(`Warning: '${role}' is not a standard Event Modeling role.`));
  }
